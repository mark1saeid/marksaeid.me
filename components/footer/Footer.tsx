    ...
    <>
      {width! > 640 ? (
        ...
        <a
          ...
          style={{ color: theme === "dark" ? "#ffffff" : selectedSocial?.color } as React.CSSProperties}
        >
  ...
  return (
    <footer className={styles.footer}>
      <div className={styles.wrapper}>
        ...
        <Link href="mailto:marksaeid10@gmail.com">marksaeid10@gmail.com</Link>
        ...
        <span className={styles.copyright}>
          &copy; {new Date().getFullYear()} Mark Saeid. All rights reserved.
        </span>
      </div>
    </footer>
  );
