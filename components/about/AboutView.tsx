      ...
      <div className={styles.container}>
        <div className={styles.collaboration}>
          ...
          <p className={styles.description}>
            ...
            offer, contact me at <Link href="mailto:marksaeid10@gmail.com">marksaeid10@gmail.com</Link>
          </p>
        </div>
        <div className={styles.contact}>
          ...
          <p className={styles.description}>
            ...
            <Link href="mailto:marksaeid10@gmail.com">email</Link>,{" "}
            <Link href="https://facebook.com/mark.saeid.90">Facebook</Link>,{" "}
            <Link href="https://twitter.com/mark1saeid">Twitter</Link> or other social media. I reply to all messages!
